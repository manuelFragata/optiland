...
class TestDoubleGaussAberrations:
    ...
    def test_third_order_all_functions(self, backend):
        double_gauss = DoubleGauss()
...
class TestSingletStopTwo:
    def test_init(self, backend):
        singlet_stop_surf_two = SingletStopSurf2()
